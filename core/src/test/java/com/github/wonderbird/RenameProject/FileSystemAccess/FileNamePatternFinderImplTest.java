...
public class FileNamePatternFinderImplTest {
    ...
    public void find_PatternMatchesThreeDirectoriesInCurrentDir_ReturnsMatchedDirectories() throws IOException {
        ...
        List<Path> expectedPaths = Arrays.asList(
            Paths.get( "target", "test-classes", "com", "github", "wonderbird", "RenameProject", "FileSystemAccess").toAbsolutePath(),
            Paths.get( "target", "classes", "com", "github", "wonderbird", "RenameProject", "FileSystemAccess").toAbsolutePath(),
            Paths.get( "src", "test", "java", "com", "github", "wonderbird", "RenameProject", "FileSystemAccess").toAbsolutePath(),
            Paths.get( "src", "main", "java", "com", "github", "wonderbird", "RenameProject", "FileSystemAccess").toAbsolutePath());
